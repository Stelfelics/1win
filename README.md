...
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *выполняет все те же действия, что вы делали бы руками:*<br>**—** *Выполнение заданий связанные с подписками*;<br>**—** *Сбор монет за рефералов*;<br>**—** *Получение ежедневной награды*;<br>**—** *Улучшение бустов*;<br>**—** *Апгрейд всех карточек до максимально возможно уровня*;<br>**—** *1 час беспрерывного тапания*;<br>**—** *Ожидание от 1 до 3 часов*;<br>**—** *Повторение действий через 1-3 часа*. |✅|
