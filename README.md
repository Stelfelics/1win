...
# 🟣 1win AutoBot /// HPV /// V1.03 🟣

| **Возможности**                                                    | **Поддерживается**  |
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *выполняет все те же действия, что вы делали бы руками:*<br>**—** *Выполнение заданий связанные с подписками*;<br>**—** *Сбор монет за рефералов*;<br>**—** *Получение ежедневной награды*;<br>**—** *Улучшение бустов `Запас энергии` и `Восстановление энергии`*;<br>**—** *Апгрейд всех карточек до максимально возможно уровня*;<br>**—** *1 час беспрерывного тапания*;<br>**—** *Ожидание от 1 до 3 часов*;<br>**—** *Повторение действий через 1-3 часа*. |✅|
...
# <br><br>🟡 Обновлено — 27.07.2024 🟡
- **Обновлены все запросы;**
- **Добавлен апгрейд бустов `Запас энергии` и `Восстановление энергии`;**
- **Изменение времени ожидания после часового тапания с 1 часа на случайное значение в диапазоне от 1 до 3 часов;**
...
- **Linux**
  ...
  - ```
    ...
    ```
  - ```
    git clone https://github.com/A-KTO-Tbl/1win
    ```
  - ```
    pip3 install -r 1win\Core\Tools\requirements.txt
    ```
- **Windows**
